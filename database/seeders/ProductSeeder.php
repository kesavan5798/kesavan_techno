...
class ProductSeeder extends Seeder
{
    ...
    {
        Product::create([
            "product_name" => "Test Product for demo",
            ...
            "images" => "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZHVjdHxlbnwwfHwwfHx8MA%3D%3D",
            "amount" => "100",
            "discount" => "10",
            "seller_id" => "1"
        ]);
